    ...
    <div v-if="isVisible" class="preview-modal" @click.self="isVisible = false">
      ...
      <div class="preview-content" :style="contentStyle">
        <a-spin :spinning="loading">
          <img v-if="type === 'image'" ref="img" :style="imgStyle" :src="url" alt="" @load.stop="imgLoaded" />
          <video v-if="type === 'video'" ref="video" :src="url" controls autoplay @canplay="loading = false"
            @loadstart="loading = true"></video>
