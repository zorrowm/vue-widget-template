...
for (var I, x, k, C, M, U, j, N, P, D, F = a(((e) => {
	...
	*/ (function(e) {
	...
	e.StringDecoder = n, n.prototype.write = function(e) {
		...
		var r = function(e, t, r) {
			...
			if (n < r) return 0;
			var o = i(t[n]);
			return o >= 0 ? (o > 0 && (e.lastNeed = o - 1), o) : --n < r || -2 === o ? 0 : (o = i(t[n])) >= 0 ? (o > 0 && (e.lastNeed = o - 2), o) : --n < r || -2 === o ? 0 : (o = i(t[n])) >= 0 ? (o > 0 && (2 === o ? o = 0 : e.lastNeed = o - 3), o) : 0;
		}(this, e, t);
	...
	var r = $().Buffer;
	function n(e, t) {
		this.enc = e.encodingName, this.bomAware = e.bomAware, "base64" === this.enc ? this.encoder = a : "utf8" === this.enc ? this.encoder = u : "cesu8" === this.enc && (this.enc = "utf8", this.encoder = c, "💩" !== r.from("eda0bdedb2a9", "hex").toString() && (this.decoder = f, this.defaultCharUnicode = t.defaultCharUnicode));
	}
	t.exports = {
		utf8: {
			type: "_internal",
		...
		hex: { type: "_internal" },
		_internal: n
	}, n.prototype.encoder = s, n.prototype.decoder = o;
	...
	o.prototype.write = function(e) {
	...
	}, s.prototype.end = function() {}, a.prototype.write = function(e) {
		...
		for (var t = r.alloc(3 * e.length), n = 0, i = 0; i < e.length; i++) {
			...
			o < 128 ? t[n++] = o : o < 2048 ? (t[n++] = 192 + (o >>> 6), t[n++] = 128 + (63 & o)) : (t[n++] = 224 + (o >>> 12), t[n++] = 128 + (o >>> 6 & 63), t[n++] = 128 + (63 & o));
		}
		return t.slice(0, n);
	}, c.prototype.end = function() {}, f.prototype.write = function(e) {
		...
		if (this.highSurrogate && (e = this.highSurrogate + e, this.highSurrogate = ""), e.length > 0) {
	...
	function o(e, t, r, n) {
		if ((r < 0 || r > 1114111) && (r = n), r >= 65536) {
			...
			e[t++] = 255 & i, e[t++] = i >> 8, r = 56320 | 1023 & r;
		}
	...
	function f(e, t) {
		var r = [], n = 0, i = 0, o = 0, s = 0, a = 0;
		e: for (var c = 0; c < e.length; c++) for (var f = e[c], u = 0; u < f.length; u++) if (r.push(f[u]), 4 === r.length) {
			if (0 === n) {
	...
	e._utf32 = r, e.utf32le = {
		...
		for (var r = t.from(e, "ucs2"), n = t.alloc(2 * r.length), i = this.isLE ? n.writeUInt32LE : n.writeUInt32BE, o = 0, s = 0; s < r.length; s += 2) {
			...
			if (this.highSurrogate) {
				if (!c && f) {
					var u = 65536 + (this.highSurrogate - 55296 << 10 | a - 56320);
					i.call(n, u, o), o += 4, this.highSurrogate = 0;
					continue;
				}
				i.call(n, this.highSurrogate, o), o += 4;
			}
			c ? this.highSurrogate = a : (i.call(n, a, o), o += 4, this.highSurrogate = 0);
		}
		return o < n.length && (n = n.slice(0, o)), n;
	...
	function c(e, t) {
		var r = [], n = 0, i = 0, o = 0;
		e: for (var s = 0; s < e.length; s++) for (var a = e[s], c = 0; c < a.length; c++) if (r.push(a[c]), 2 === r.length) {
			if (0 === n) {
	...
	e.utf16be = r, r.prototype.encoder = n, r.prototype.decoder = i, r.prototype.bomAware = !0, n.prototype.write = function(e) {
		for (var r = t.from(e, "ucs2"), n = 0; n < r.length; n += 2) {
			var i = r[n];
			r[n] = r[n + 1], r[n + 1] = i;
		}
		return r;
	}, n.prototype.end = function() {}, i.prototype.write = function(e) {
		if (0 == e.length) return "";
		var r = t.alloc(e.length + 1), n = 0, i = 0;
		for (-1 !== this.overflowByte && (r[0] = e[0], r[1] = this.overflowByte, n = 1, i = 2); n < e.length - 1; n += 2, i += 2) r[i] = e[n + 1], r[i + 1] = e[n];
		return this.overflowByte = n == e.length - 1 ? e[e.length - 1] : -1, r.slice(0, i).toString("ucs2");
	}, i.prototype.end = function() {
		this.overflowByte = -1;
	}, e.utf16 = o, o.prototype.encoder = s, o.prototype.decoder = a, s.prototype.write = function(e) {
		return this.encoder.write(e);
	...
	i.prototype.write = function(e) {
		return t.from(e.replace(n, function(e) {
			return "+" + ("+" === e ? "" : this.iconv.encode(e, "utf16-be").toString("base64").replace(/=+$/, "")) + "-";
		}.bind(this)));
	}, i.prototype.end = function() {};
	for (var s = /[A-Za-z0-9\/+]/, a = [], c = 0; c < 256; c++) a[c] = s.test(String.fromCharCode(c));
	var f = "+".charCodeAt(0), u = "-".charCodeAt(0), h = "&".charCodeAt(0);
	function l(e, t) {
		this.iconv = t;
	}
	function d(e, r) {
		this.iconv = r.iconv, this.inBase64 = !1, this.base64Accum = t.alloc(6), this.base64AccumIdx = 0;
	}
	function p(e, t) {
		this.iconv = t.iconv, this.inBase64 = !1, this.base64Accum = "";
	}
	o.prototype.write = function(e) {
		for (var r = "", n = 0, i = this.inBase64, o = this.base64Accum, s = 0; s < e.length; s++) if (i) {
			if (!a[e[s]]) {
				if (s == n && e[s] == u) r += "+";
				else {
					var c = o + this.iconv.decode(e.slice(n, s), "ascii");
					r += this.iconv.decode(t.from(c, "base64"), "utf16-be");
				}
				e[s] != u && s--, n = s + 1, i = !1, o = "";
			}
		} else e[s] == f && (r += this.iconv.decode(e.slice(n, s), "ascii"), n = s + 1, i = !0);
		if (i) {
			var h = (c = o + this.iconv.decode(e.slice(n), "ascii")).length - c.length % 8;
			o = c.slice(h), c = c.slice(0, h), r += this.iconv.decode(t.from(c, "base64"), "utf16-be");
		} else r += this.iconv.decode(e.slice(n), "ascii");
	...
	}, e.utf7imap = l, l.prototype.encoder = d, l.prototype.decoder = p, l.prototype.bomAware = !0, d.prototype.write = function(e) {
		for (var r = this.inBase64, n = this.base64Accum, i = this.base64AccumIdx, o = t.alloc(5 * e.length + 10), s = 0, a = 0; a < e.length; a++) {
			var c = e.charCodeAt(a);
			c >= 32 && c <= 126 ? (r && (i > 0 && (s += o.write(n.slice(0, i).toString("base64").replace(/\//g, ",").replace(/=+$/, ""), s), i = 0), o[s++] = u, r = !1), r || (o[s++] = c, c === h && (o[s++] = u))) : (r || (o[s++] = h, r = !0), r && (n[i++] = c >> 8, n[i++] = 255 & c, i == n.length && (s += o.write(n.toString("base64").replace(/\//g, ","), s), i = 0)));
		}
		return this.inBase64 = r, this.base64AccumIdx = i, o.slice(0, s);
	}, d.prototype.end = function() {
		var e = t.alloc(10), r = 0;
		return this.inBase64 && (this.base64AccumIdx > 0 && (r += e.write(this.base64Accum.slice(0, this.base64AccumIdx).toString("base64").replace(/\//g, ",").replace(/=+$/, ""), r), this.base64AccumIdx = 0), e[r++] = u, this.inBase64 = !1), e.slice(0, r);
	};
	var b = a.slice();
	b[",".charCodeAt(0)] = !0, p.prototype.write = function(e) {
		for (var r = "", n = 0, i = this.inBase64, o = this.base64Accum, s = 0; s < e.length; s++) if (i) {
			if (!b[e[s]]) {
				if (s == n && e[s] == u) r += "&";
				else {
					var a = o + this.iconv.decode(e.slice(n, s), "ascii").replace(/,/g, "/");
					r += this.iconv.decode(t.from(a, "base64"), "utf16-be");
				}
				e[s] != u && s--, n = s + 1, i = !1, o = "";
			}
		} else e[s] == h && (r += this.iconv.decode(e.slice(n, s), "ascii"), n = s + 1, i = !0);
		if (i) {
			var c = (a = o + this.iconv.decode(e.slice(n), "ascii").replace(/,/g, "/")).length - a.length % 8;
			o = a.slice(c), a = a.slice(0, c), r += this.iconv.decode(t.from(a, "base64"), "utf16-be");
		} else r += this.iconv.decode(e.slice(n), "ascii");
		return this.inBase64 = i, this.base64Accum = o, r;
	...
	function r(e, r) {
		...
		var o = t.alloc(65536, r.defaultCharSingleByte.charCodeAt(0));
	...
	e._sbcs = r, r.prototype.encoder = n, r.prototype.decoder = i, n.prototype.write = function(e) {
		for (var r = t.alloc(e.length), n = 0; n < e.length; n++) r[n] = this.encodeBuf[e.charCodeAt(n)];
		return r;
	}, n.prototype.end = function() {}, i.prototype.write = function(e) {
		for (var r = this.decodeBuf, n = t.alloc(2 * e.length), i = 0, o = 0, s = 0; s < e.length; s++) i = 2 * e[s], n[o = 2 * s] = r[i], n[o + 1] = r[i + 1];
	...
	var t = $().Buffer;
	e._dbcs = c;
	for (var r = -1, n = -2, i = -10, o = -1e3, s = new Array(256), a = 0; a < 256; a++) s[a] = r;
	function c(e, t) {
		...
		if ("function" == typeof e.gb18030) {
			...
			for (a = 129; a <= 254; a++) for (var h = this.decodeTables[o - u[a]], l = 48; l <= 57; l++) {
				if (h[l] === r) h[l] = o - c;
				else if (h[l] > o) throw new Error("gb18030 decode tables conflict at byte 2");
				for (var d = this.decodeTables[o - h[l]], p = 129; p <= 254; p++) {
					if (d[p] === r) d[p] = o - f;
					else {
						if (d[p] === o - f) continue;
						if (d[p] > o) throw new Error("gb18030 decode tables conflict at byte 3");
					}
					for (var b = this.decodeTables[o - d[p]], g = 48; g <= 57; g++) b[g] === r && (b[g] = n);
				}
			}
		}
		this.defaultCharUnicode = t.defaultCharUnicode, this.encodeTable = [], this.encodeTableSeq = [];
		var y = {};
		if (e.encodeSkipVals) for (a = 0; a < e.encodeSkipVals.length; a++) {
			var w = e.encodeSkipVals[a];
			if ("number" == typeof w) y[w] = !0;
			else for (l = w.from; l <= w.to; l++) y[l] = !0;
		}
		if (this._fillEncodeTable(0, 0, y), e.encodeAdd) for (var v in e.encodeAdd) Object.prototype.hasOwnProperty.call(e.encodeAdd, v) && this._setEncodeChar(v.charCodeAt(0), e.encodeAdd[v]);
	...
	c.prototype.encoder = f, c.prototype.decoder = u, c.prototype._getDecodeTrieNode = function(e) {
		for (var t = []; e > 0; e >>>= 8) t.push(255 & e);
		0 == t.length && t.push(0);
		for (var n = this.decodeTables[0], i = t.length - 1; i > 0; i--) {
			var a = n[t[i]];
			if (a == r) n[t[i]] = o - this.decodeTables.length, this.decodeTables.push(n = s.slice(0));
			else {
				if (!(a <= o)) throw new Error("Overwrite byte in " + this.encodingName + ", addr: " + e.toString(16));
		...
		for (var n = 1; n < e.length; n++) {
			var o = e[n];
			if ("string" == typeof o) for (var s = 0; s < o.length;) {
				var a = o.charCodeAt(s++);
				if (a >= 55296 && a < 56320) {
					var c = o.charCodeAt(s++);
					if (!(c >= 56320 && c < 57344)) throw new Error("Incorrect surrogate pair in " + this.encodingName + " at chunk " + e[0]);
					r[t++] = 65536 + 1024 * (a - 55296) + (c - 56320);
				} else if (a > 4080 && a <= 4095) {
					for (var f = 4095 - a + 2, u = [], h = 0; h < f; h++) u.push(o.charCodeAt(s++));
					r[t++] = i - this.decodeTableSeq.length, this.decodeTableSeq.push(u);
				} else r[t++] = a;
			}
			else {
		...
		var n = this._getEncodeBucket(e), o = 255 & e;
		n[o] <= i ? this.encodeTableSeq[i - n[o]][-1] = t : n[o] == r && (n[o] = t);
	}, c.prototype._setEncodeSequence = function(e, t) {
		var n, o = e[0], s = this._getEncodeBucket(o), a = 255 & o;
		s[a] <= i ? n = this.encodeTableSeq[i - s[a]] : (n = {}, s[a] !== r && (n[-1] = s[a]), s[a] = i - this.encodeTableSeq.length, this.encodeTableSeq.push(n));
		for (var c = 1; c < e.length - 1; c++) {
			var f = n[o];
			"object" == typeof f ? n = f : (n = n[o] = {}, void 0 !== f && (n[-1] = f));
		}
		n[o = e[e.length - 1]] = t;
	}, c.prototype._fillEncodeTable = function(e, t, r) {
		for (var n = this.decodeTables[e], s = !1, a = {}, c = 0; c < 256; c++) {
			var f = n[c], u = t + c;
			if (!r[u]) if (f >= 0) this._setEncodeChar(f, u), s = !0;
			else if (f <= o) {
				var h = o - f;
				if (!a[h]) {
					var l = u << 8 >>> 0;
					this._fillEncodeTable(h, l, r) ? s = !0 : a[h] = !0;
				}
			} else f <= i && (this._setEncodeSequence(this.decodeTableSeq[i - f], u), s = !0);
		}
		return s;
	}, f.prototype.write = function(e) {
		for (var n = t.alloc(e.length * (this.gb18030 ? 4 : 3)), o = this.leadSurrogate, s = this.seqObj, a = -1, c = 0, f = 0;;) {
			if (-1 === a) {
				if (c == e.length) break;
				var u = e.charCodeAt(c++);
			} else u = a, a = -1;
			if (u >= 55296 && u < 57344) if (u < 56320) {
				if (-1 === o) {
					o = u;
					continue;
				}
				o = u, u = r;
			} else -1 !== o ? (u = 65536 + 1024 * (o - 55296) + (u - 56320), o = -1) : u = r;
			else -1 !== o && (a = u, u = r, o = -1);
			var l = r;
			if (void 0 !== s && u != r) {
				var d = s[u];
				if ("object" == typeof d) {
				...
				"number" == typeof d ? l = d : null == d && void 0 !== (d = s[-1]) && (l = d, a = u), s = void 0;
			} else if (u >= 0) {
				var p = this.encodeTable[u >> 8];
				if (void 0 !== p && (l = p[255 & u]), l <= i) {
					s = this.encodeTableSeq[i - l];
					continue;
				}
				if (l == r && this.gb18030) {
					var b = h(this.gb18030.uChars, u);
					if (-1 != b) {
						l = this.gb18030.gbChars[b] + (u - this.gb18030.uChars[b]), n[f++] = 129 + Math.floor(l / 12600), l %= 12600, n[f++] = 48 + Math.floor(l / 1260), l %= 1260, n[f++] = 129 + Math.floor(l / 10), l %= 10, n[f++] = 48 + l;
						continue;
					}
				}
			}
			l === r && (l = this.defaultCharSingleByte), l < 256 ? n[f++] = l : l < 65536 ? (n[f++] = l >> 8, n[f++] = 255 & l) : l < 16777216 ? (n[f++] = l >> 16, n[f++] = l >> 8 & 255, n[f++] = 255 & l) : (n[f++] = l >>> 24, n[f++] = l >>> 16 & 255, n[f++] = l >>> 8 & 255, n[f++] = 255 & l);
		}
		return this.seqObj = s, this.leadSurrogate = o, n.slice(0, f);
	}, f.prototype.end = function() {
		if (-1 !== this.leadSurrogate || void 0 !== this.seqObj) {
			var e = t.alloc(10), r = 0;
			if (this.seqObj) {
				var n = this.seqObj[-1];
				void 0 !== n && (n < 256 ? e[r++] = n : (e[r++] = n >> 8, e[r++] = 255 & n)), this.seqObj = void 0;
			}
			return -1 !== this.leadSurrogate && (e[r++] = this.defaultCharSingleByte, this.leadSurrogate = -1), e.slice(0, r);
		}
	}, f.prototype.findIdx = h, u.prototype.write = function(e) {
		for (var s = t.alloc(2 * e.length), a = this.nodeIdx, c = this.prevBytes, f = this.prevBytes.length, u = -this.prevBytes.length, l = 0, d = 0; l < e.length; l++) {
			var p, b = l >= 0 ? e[l] : c[l + f];
			if ((p = this.decodeTables[a][b]) >= 0);
			else if (p === r) p = this.defaultCharUnicode.charCodeAt(0), l = u;
			else if (p === n) {
				if (l >= 3) var g = 12600 * (e[l - 3] - 129) + 1260 * (e[l - 2] - 48) + 10 * (e[l - 1] - 129) + (b - 48);
				else g = 12600 * (c[l - 3 + f] - 129) + 1260 * ((l - 2 >= 0 ? e[l - 2] : c[l - 2 + f]) - 48) + 10 * ((l - 1 >= 0 ? e[l - 1] : c[l - 1 + f]) - 129) + (b - 48);
				var y = h(this.gb18030.gbChars, g);
				...
				if (!(p <= i)) throw new Error("iconv-lite internal error: invalid decoding table value " + p + " at " + a + "/" + b);
				for (var w = this.decodeTableSeq[i - p], v = 0; v < w.length - 1; v++) p = w[v], s[d++] = 255 & p, s[d++] = p >> 8;
				p = w[w.length - 1];
			}
			if (p >= 65536) {
				var m = 55296 | (p -= 65536) >> 10;
				s[d++] = 255 & m, s[d++] = m >> 8, p = 56320 | 1023 & p;
			}
			s[d++] = 255 & p, s[d++] = p >> 8, a = 0, u = l + 1;
		}
		return this.nodeIdx = a, this.prevBytes = u >= 0 ? Array.prototype.slice.call(e, u) : c.slice(u + f).concat(Array.prototype.slice.call(e)), s.slice(0, d).toString("ucs2");
	}, u.prototype.end = function() {
	...
	t.exports = {
		...
		cp936: {
			type: "_dbcs",
			table: function() {
				return oe(), u(ie).default;
			}
		},
		gbk: {
			type: "_dbcs",
			table: function() {
				return (oe(), u(ie).default).concat((ae(), u(se).default));
			}
		},
		xgbk: "gbk",
		isoir58: "gbk",
		...
		big5hkscs: {
			type: "_dbcs",
			table: function() {
				return (de(), u(le).default).concat((be(), u(pe).default));
			},
			encodeSkipVals: [
				36457,
				36463,
	...
	t.exports = function(e) {
		...
		return n.prototype = Object.create(t.prototype, { constructor: { value: n } }), n.prototype._transform = function(e, t, r) {
			if ("string" != typeof e) return r(/* @__PURE__ */ new Error("Iconv encoding stream needs strings as its input."));
			try {
		...
		}, i.prototype = Object.create(t.prototype, { constructor: { value: i } }), i.prototype._transform = function(e, t, n) {
			if (!(r.isBuffer(e) || e instanceof Uint8Array)) return n(/* @__PURE__ */ new Error("Iconv decoding stream needs buffers as its input."));
			try {
	...
	var r, n = "object" == typeof Reflect ? Reflect : null, i = n && "function" == typeof n.apply ? n.apply : function(e, t, r) {
	...
	t.exports = s, t.exports.once = function(e, t) {
		return new Promise((function(r, n) {
			...
			g(e, t, o, { once: !0 }), "error" !== t && function(e, t) {
	...
	function u(e, t, r, n) {
		...
		else if ("function" == typeof s ? s = o[t] = n ? [r, s] : [s, r] : n ? s.unshift(r) : s.push(r), (i = f(e)) > 0 && s.length > i && !s.warned) {
			s.warned = !0;
			var u = /* @__PURE__ */ new Error("Possible EventEmitter memory leak detected. " + s.length + " " + String(t) + " listeners added. Use emitter.setMaxListeners() to increase limit");
	...
	var a = F().Buffer, c = _e().inspect, f = c && c.custom || "inspect";
	function u(e, t, r) {
	...
	t.exports = function() {
		...
		return t = e, r = [
			...
			},
			{
				...
				value: function(e) {
					...
					for (var t = a.allocUnsafe(e >>> 0), r = this.head, n = 0; r;) u(r.data, t, n), n += r.data.length, r = r.next;
					return t;
				}
			},
			{
		...
		], r && o(t.prototype, r), Object.defineProperty(t, "prototype", { writable: !1 }), e;
	}();
})), Be = a(((e, t) => {
	function r(e, t) {
		i(e, t), n(e);
	...
	t.exports = {
		destroy: function(e, t) {
			...
			return s || a ? (t ? t(e) : e && (this._writableState ? this._writableState.errorEmitted || (this._writableState.errorEmitted = !0, process.nextTick(i, this, e)) : process.nextTick(i, this, e)), this) : (this._readableState && (this._readableState.destroyed = !0), this._writableState && (this._writableState.destroyed = !0), this._destroy(e || null, (function(e) {
				!t && e ? o._writableState ? o._writableState.errorEmitted ? process.nextTick(n, o) : (o._writableState.errorEmitted = !0, process.nextTick(r, o, e)) : process.nextTick(r, o, e) : t ? (process.nextTick(n, o), t(e)) : process.nextTick(n, o);
			})), this);
		},
		undestroy: function() {
	...
	n("ERR_INVALID_OPT_VALUE", (function(e, t) {
		...
		}(e, " argument")) s = "The ".concat(e, " ").concat(n, " ").concat(i(t, "type"));
		else {
			var a = function(e, t, r) {
				return "number" != typeof r && (r = 0), !(r + 1 > e.length) && -1 !== e.indexOf(".", r);
			}(e) ? "property" : "argument";
			s = "The \"".concat(e, "\" ").concat(a, " ").concat(n, " ").concat(i(t, "type"));
		}
	...
	var r = Re().codes.ERR_INVALID_OPT_VALUE;
	t.exports = { getHighWaterMark: function(e, t, n, i) {
	...
	var n;
	t.exports = S, S.WritableState = _;
	var i, o = { deprecate: Ae() }, s = Ee(), a = F().Buffer, c = ("undefined" != typeof global ? global : "undefined" != typeof window ? window : "undefined" != typeof self ? self : {}).Uint8Array || function() {}, f = Be(), u = Te().getHighWaterMark, h = Re().codes, l = h.ERR_INVALID_ARG_TYPE, d = h.ERR_METHOD_NOT_IMPLEMENTED, p = h.ERR_MULTIPLE_CALLBACK, b = h.ERR_STREAM_CANNOT_PIPE, g = h.ERR_STREAM_DESTROYED, y = h.ERR_STREAM_NULL_VALUES, w = h.ERR_STREAM_WRITE_AFTER_END, v = h.ERR_UNKNOWN_ENCODING, m = f.errorOrDestroy;
	function E() {}
	function _(e, t, i) {
		n = n || Oe(), e = e || {}, "boolean" != typeof i && (i = t instanceof n), this.objectMode = !!e.objectMode, i && (this.objectMode = this.objectMode || !!e.writableObjectMode), this.highWaterMark = u(this, e, "writableHighWaterMark", i), this.finalCalled = !1, this.needDrain = !1, this.ending = !1, this.ended = !1, this.finished = !1, this.destroyed = !1;
		...
		this.decodeStrings = !o, this.defaultEncoding = e.defaultEncoding || "utf8", this.length = 0, this.writing = !1, this.corked = 0, this.sync = !0, this.bufferProcessing = !1, this.onwrite = function(e) {
			(function(e, t) {
				...
				if (function(e) {
					...
					--t.pendingcb, r ? (process.nextTick(i, n), process.nextTick(O, e, t), e._writableState.errorEmitted = !0, m(e, n)) : (i(n), e._writableState.errorEmitted = !0, m(e, n), O(e, t));
				})(e, r, n, t, i);
				else {
					var o = A(r) || e.destroyed;
					o || r.corked || r.bufferProcessing || !r.bufferedRequest || T(e, r), n ? process.nextTick(R, e, r, o, i) : R(e, r, o, i);
				}
			})(t, e);
	...
	function T(e, t) {
		...
		if (e._writev && n && n.next) {
			...
			o.allBuffers = c, B(e, t, !0, t.length, o, "", s.finish), t.pendingcb++, t.lastBufferedRequest = null, s.next ? (t.corkedRequestsFree = s.next, s.next = null) : t.corkedRequestsFree = new r(t), t.bufferedRequestCount = 0;
		} else {
			for (; n;) {
				var f = n.chunk, u = n.encoding, h = n.callback;
				if (B(e, t, !1, t.objectMode ? 1 : f.length, f, u, h), n = n.next, t.bufferedRequestCount--, t.writing) break;
			}
	...
	function O(e, t) {
		var r = A(t);
		if (r && (function(e, t) {
			t.prefinished || t.finalCalled || ("function" != typeof e._final || t.destroyed ? (t.prefinished = !0, e.emit("prefinish")) : (t.pendingcb++, t.finalCalled = !0, process.nextTick(L, e, t)));
	...
	me()(S, s), _.prototype.getBuffer = function() {
		for (var e = this.bufferedRequest, t = []; e;) t.push(e), e = e.next;
		return t;
	}, function() {
		try {
			Object.defineProperty(_.prototype, "buffer", { get: o.deprecate((function() {
				return this.getBuffer();
			}), "_writableState.buffer is deprecated. Use _writableState.getBuffer instead.", "DEP0003") });
		} catch (e) {}
	}(), "function" == typeof Symbol && Symbol.hasInstance && "function" == typeof Function.prototype[Symbol.hasInstance] ? (i = Function.prototype[Symbol.hasInstance], Object.defineProperty(S, Symbol.hasInstance, { value: function(e) {
		...
		var n, i = this._writableState, o = !1, s = !i.objectMode && (n = e, a.isBuffer(n) || n instanceof c);
		return s && !a.isBuffer(e) && (e = function(e) {
			...
			var i;
			return null === r ? i = new y() : "string" == typeof r || t.objectMode || (i = new l("chunk", ["string", "Buffer"], r)), !i || (m(e, i), process.nextTick(n, i), !1);
	...
	}), S.prototype.destroy = f.destroy, S.prototype._undestroy = f.undestroy, S.prototype._destroy = function(e, t) {
		t(e);
	};
})), Oe = a(((e, t) => {
	...
	function c(e) {
		...
		n.call(this, e), i.call(this, e), this.allowHalfOpen = !0, e && (!1 === e.readable && (this.readable = !1), !1 === e.writable && (this.writable = !1), !1 === e.allowHalfOpen && (this.allowHalfOpen = !1, this.once("end", f)));
	}
	function f() {
	...
	var r = Re().codes.ERR_STREAM_PREMATURE_CLOSE;
	function n() {}
	t.exports = function e(t, i, o) {
		...
		var s = i.readable || !1 !== i.readable && t.readable, a = i.writable || !1 !== i.writable && t.writable, c = function() {
			t.writable || u();
		}, f = t._writableState && t._writableState.finished, u = function() {
			a = !1, f = !0, s || o.call(t);
		}, h = t._readableState && t._readableState.endEmitted, l = function() {
			s = !1, h = !0, a || o.call(t);
		}, d = function(e) {
			o.call(t, e);
		}, p = function() {
			var e;
			return s && !h ? (t._readableState && t._readableState.ended || (e = new r()), o.call(t, e)) : a && !f ? (t._writableState && t._writableState.ended || (e = new r()), o.call(t, e)) : void 0;
		}, b = function() {
			t.req.on("finish", u);
		};
		return function(e) {
			return e.setHeader && "function" == typeof e.abort;
		}(t) ? (t.on("complete", u), t.on("abort", p), t.req ? b() : t.on("request", b)) : a && !t._writableState && (t.on("end", c), t.on("close", c)), t.on("end", l), t.on("finish", u), !1 !== i.error && t.on("error", d), t.on("close", p), function() {
			t.removeListener("complete", u), t.removeListener("abort", p), t.removeListener("request", b), t.req && t.req.removeListener("finish", u), t.removeListener("end", c), t.removeListener("close", c), t.removeListener("finish", u), t.removeListener("end", l), t.removeListener("error", d), t.removeListener("close", p);
		};
	};
})), xe = a(((e, t) => {
	var r;
	...
	var i = Ie(), o = Symbol("lastResolve"), s = Symbol("lastReject"), a = Symbol("error"), c = Symbol("ended"), f = Symbol("lastPromise"), u = Symbol("handlePromise"), h = Symbol("stream");
	function l(e, t) {
		return {
			value: e,
			done: t
	...
	function d(e) {
		...
		if (null !== t) {
			var r = e[h].read();
			null !== r && (e[f] = null, e[o] = null, e[s] = null, t(l(r, !1)));
		}
	}
	function p(e) {
		process.nextTick(d, e);
	}
	var b = Object.getPrototypeOf((function() {})), g = Object.setPrototypeOf((n(r = {
		get stream() {
			return this[h];
		},
		next: function() {
	...
	t.exports = function(e) {
		var t, r = Object.create(g, (n(t = {}, h, {
			...
			value: function(e, t) {
				var n = r[h].read();
				n ? (r[f] = null, r[o] = null, r[s] = null, e(l(n, !1))) : (r[o] = e, r[s] = t);
			},
			writable: !0
		}), t));
		return r[f] = null, i(e, (function(e) {
			if (e && "ERR_STREAM_PREMATURE_CLOSE" !== e.code) {
				var t = r[s];
				null !== t && (r[f] = null, r[o] = null, r[s] = null, t(e)), r[a] = e;
				return;
			}
			var n = r[o];
			null !== n && (r[f] = null, r[o] = null, r[s] = null, n(l(void 0, !0))), r[c] = !0;
		})), e.on("readable", p.bind(null, r)), r;
	};
})), ke = a(((e, t) => {
	t.exports = function() {
	...
	var r;
	t.exports = S, S.ReadableState = _, ve().EventEmitter;
	var n, i = function(e, t) {
		return e.listeners(t).length;
	}, o = Ee(), s = F().Buffer, a = ("undefined" != typeof global ? global : "undefined" != typeof window ? window : "undefined" != typeof self ? self : {}).Uint8Array || function() {}, c = _e();
	n = c && c.debuglog ? c.debuglog("stream") : function() {};
	var f, u, h, l = Se(), d = Be(), p = Te().getHighWaterMark, b = Re().codes, g = b.ERR_INVALID_ARG_TYPE, y = b.ERR_STREAM_PUSH_AFTER_EOF, w = b.ERR_METHOD_NOT_IMPLEMENTED, v = b.ERR_STREAM_UNSHIFT_AFTER_END_EVENT;
	me()(S, o);
	var m = d.errorOrDestroy, E = [
		"error",
		"close",
		"destroy",
		"pause",
	...
	function B(e, t, r, i, o) {
		...
		else if (o || (c = function(e, t) {
			var r, n;
			return n = t, s.isBuffer(n) || n instanceof a || "string" == typeof t || void 0 === t || e.objectMode || (r = new g("chunk", [
				"string",
				"Buffer",
				"Uint8Array"
			], t)), r;
		}(f, t)), c) m(e, c);
		else if (f.objectMode || t && t.length > 0) if ("string" == typeof t || f.objectMode || Object.getPrototypeOf(t) === s.prototype || (t = function(e) {
			return s.from(e);
		}(t)), i) f.endEmitted ? m(e, new v()) : R(e, f, t, !0);
		else if (f.ended) m(e, new y());
		else {
			if (f.destroyed) return !1;
			f.reading = !1, f.decoder && !r ? (t = f.decoder.write(t), f.objectMode || 0 !== t.length ? R(e, f, t, !1) : I(e, f)) : R(e, f, t, !1);
		}
		else i || (f.reading = !1, I(e, f));
		return !f.ended && (f.length < f.highWaterMark || 0 === f.length);
	}
	function R(e, t, r, n) {
		t.flowing && 0 === t.length && !t.sync ? (t.awaitDrain = 0, e.emit("data", r)) : (t.length += t.objectMode ? 1 : r.length, n ? t.buffer.unshift(r) : t.buffer.push(r), t.needReadable && L(e)), I(e, t);
	}
	Object.defineProperty(S.prototype, "destroyed", {
		enumerable: !1,
		get: function() {
		...
		return n.objectMode ? r = !0 : "string" == typeof e && ((t = t || n.defaultEncoding) !== n.encoding && (e = s.from(e, t), t = ""), r = !0), B(this, e, t, !1, r);
	...
	function O(e) {
		var t = e._readableState;
		n("emitReadable_", t.destroyed, t.length, t.ended), t.destroyed || !t.length && !t.ended || (e.emit("readable"), t.emittedReadable = !1), t.needReadable = !t.flowing && !t.ended && t.length <= t.highWaterMark, U(e);
	}
	function I(e, t) {
		t.readingMore || (t.readingMore = !0, process.nextTick(x, e, t));
	}
	function x(e, t) {
	...
	function M(e, t) {
		n("resume", t.reading), t.reading || e.read(0), t.resumeScheduled = !1, e.emit("resume"), U(e), t.flowing && !t.reading && e.read(0);
	}
	function U(e) {
		var t = e._readableState;
	...
	function N(e) {
		var t = e._readableState;
		n("endReadable", t.endEmitted), t.endEmitted || (t.ended = !0, process.nextTick(P, t, e));
	}
	function P(e, t) {
	...
	S.prototype.read = function(e) {
		...
		if (0 !== e && (t.emittedReadable = !1), 0 === e && t.needReadable && ((0 !== t.highWaterMark ? t.length >= t.highWaterMark : t.length > 0) || t.ended)) return n("read: emitReadable", t.length, t.ended), 0 === t.length && t.ended ? N(this) : L(this), null;
		if (0 === (e = A(e, t)) && t.ended) return 0 === t.length && N(this), null;
		var i, o = t.needReadable;
		return n("need readable", o), (0 === t.length || t.length - e < t.highWaterMark) && n("length less than watermark", o = !0), t.ended || t.reading ? n("reading or ended", o = !1) : o && (n("do read"), t.reading = !0, t.sync = !0, 0 === t.length && (t.needReadable = !0), this._read(t.highWaterMark), t.sync = !1, t.reading || (e = A(r, t))), null === (i = e > 0 ? j(e, t) : null) ? (t.needReadable = t.length <= t.highWaterMark, e = 0) : (t.length -= e, t.awaitDrain = 0), 0 === t.length && (t.ended || (t.needReadable = !0), r !== e && t.ended && N(this)), null !== i && this.emit("data", i), i;
		...
		o.endEmitted ? process.nextTick(s) : r.once("end", s), e.on("unpipe", (function t(i, s) {
			n("onunpipe"), i === r && s && !1 === s.hasUnpiped && (s.hasUnpiped = !0, n("cleanup"), e.removeListener("close", l), e.removeListener("finish", d), e.removeListener("drain", c), e.removeListener("error", h), e.removeListener("unpipe", t), r.removeListener("end", a), r.removeListener("end", p), r.removeListener("data", u), f = !0, !o.awaitDrain || e._writableState && !e._writableState.needDrain || c());
		}));
		var c = function(e) {
			return function() {
				var t = e._readableState;
				n("pipeOnDrain", t.awaitDrain), t.awaitDrain && t.awaitDrain--, 0 === t.awaitDrain && i(e, "data") && (t.flowing = !0, U(e));
			};
		}(r);
		e.on("drain", c);
		var f = !1;
		function u(t) {
			n("ondata");
			var i = e.write(t);
			n("dest.write", i), !1 === i && ((1 === o.pipesCount && o.pipes === e || o.pipesCount > 1 && -1 !== D(o.pipes, e)) && !f && (n("false write response, pause", o.awaitDrain), o.awaitDrain++), r.pause());
		}
		function h(t) {
			n("onerror", t), p(), e.removeListener("error", h), 0 === i(e, "error") && m(e, t);
		}
		function l() {
			e.removeListener("finish", d), p();
		}
		function d() {
			n("onfinish"), e.removeListener("close", l), p();
		}
		function p() {
			n("unpipe"), r.unpipe(e);
		}
		...
		}(e, "error", h), e.once("close", l), e.once("finish", d), e.emit("pipe", r), o.flowing || (n("pipe resume"), r.resume()), e;
		...
		return "data" === e ? (i.readableListening = this.listenerCount("readable") > 0, !1 !== i.flowing && this.resume()) : "readable" === e && (i.endEmitted || i.readableListening || (i.readableListening = i.needReadable = !0, i.flowing = !1, i.emittedReadable = !1, n("on readable", i.length, i.reading), i.length ? L(this) : i.reading || process.nextTick(C, this))), r;
		...
		return "readable" === e && process.nextTick(k, this), r;
	}, S.prototype.removeAllListeners = function(e) {
		var t = o.prototype.removeAllListeners.apply(this, arguments);
		return "readable" !== e && void 0 !== e || process.nextTick(k, this), t;
		...
		for (var o in e.on("end", (function() {
			...
			n("wrapped data"), r.decoder && (o = r.decoder.write(o)), r.objectMode && null == o || (r.objectMode || o && o.length) && (t.push(o) || (i = !0, e.pause()));
		...
		return void 0 === h && (h = ke()), h(S, e, t);
	});
})), Me = a(((e, t) => {
	t.exports = f;
	var r = Re().codes, n = r.ERR_METHOD_NOT_IMPLEMENTED, i = r.ERR_MULTIPLE_CALLBACK, o = r.ERR_TRANSFORM_ALREADY_TRANSFORMING, s = r.ERR_TRANSFORM_WITH_LENGTH_0, a = Oe();
	function c(e, t) {
	...
	me()(f, a), f.prototype.push = function(e, t) {
	...
	me()(n, r), n.prototype._transform = function(e, t, r) {
		r(null, e);
	};
})), je = a(((e, t) => {
	var r, n = Re().codes, i = n.ERR_MISSING_ARGS, o = n.ERR_STREAM_DESTROYED;
	function s(e) {
		if (e) throw e;
	}
	function a(e) {
	...
	t.exports = function() {
		...
		var h = t.map((function(e, n) {
			...
			return function(e, t, n, i) {
				...
				var a = !1;
				return function(t) {
					if (!s && !a) return a = !0, function(e) {
						return e.setHeader && "function" == typeof e.abort;
					}(e) ? e.abort() : "function" == typeof e.destroy ? e.destroy() : void i(t || new o("pipe"));
				};
			}(e, i, n > 0, (function(e) {
				f || (f = e), e && h.forEach(a), i || (h.forEach(a), u(f));
			}));
		}));
		return t.reduce(c);
	};
	...
	t.exports = n;
	var r = ve().EventEmitter;
	function n() {
		r.call(this);
	}
	me()(n, r), n.Readable = Ce(), n.Writable = Le(), n.Duplex = Oe(), n.Transform = Me(), n.PassThrough = Ue(), n.finished = Ie(), n.pipeline = je(), n.Stream = n, n.prototype.pipe = function(e, t) {
		var n = this;
		function i(t) {
		...
		function u() {
			n.removeListener("data", i), e.removeListener("drain", o), n.removeListener("end", a), n.removeListener("close", c), n.removeListener("error", f), e.removeListener("error", f), n.removeListener("end", u), n.removeListener("close", u), e.removeListener("close", u);
		}
		return n.on("error", f), e.on("error", f), n.on("end", u), n.on("close", u), e.on("close", u), e.emit("pipe", n), e;
	};
})), Pe = ((r, n, o) => (o = null != r ? e(i(r)) : {}, f(!n && r && r.__esModule ? o : t(o, "default", {
	value: r,
	enumerable: !0
}), r)))(a(((e, t) => {
	var r, n = $().Buffer, i = q(), o = W();
	t.exports.encodings = null, t.exports.defaultCharUnicode = "�", t.exports.defaultCharSingleByte = "?", t.exports.encode = function(e, r, i) {
		e = "" + (e || "");
		var o = t.exports.getEncoder(r, i), s = o.write(e), a = o.end();
		return a && a.length > 0 ? n.concat([s, a]) : s;
	}, t.exports.decode = function(e, r, i) {
		"string" == typeof e && (t.exports.skipDecodeWarning || (console.error("Iconv-lite warning: decode()-ing strings is deprecated. Refer to https://github.com/ashtuchkin/iconv-lite/wiki/Use-Buffers-when-decoding"), t.exports.skipDecodeWarning = !0), e = n.from("" + (e || ""), "binary"));
		var o = t.exports.getDecoder(r, i), s = o.write(e), a = o.end();
		return a ? s + a : s;
	}, t.exports.encodingExists = function(e) {
		try {
			return t.exports.getCodec(e), !0;
		} catch (e) {
			return !1;
		}
	}, t.exports.toEncoding = t.exports.encode, t.exports.fromEncoding = t.exports.decode, t.exports._codecDataCache = { __proto__: null }, t.exports.getCodec = function(e) {
		if (!t.exports.encodings) {
			var r = ye();
			t.exports.encodings = { __proto__: null }, o(t.exports.encodings, r);
		}
		for (var n = t.exports._canonicalizeEncoding(e), i = {};;) {
			var s = t.exports._codecDataCache[n];
			if (s) return s;
			var a = t.exports.encodings[n];
			switch (typeof a) {
				case "string":
					n = a;
					break;
				case "object":
					...
					i.encodingName || (i.encodingName = n), n = a.type;
					break;
				case "function": return i.encodingName || (i.encodingName = n), s = new a(i, t.exports), t.exports._codecDataCache[i.encodingName] = s, s;
				default: throw new Error("Encoding not recognized: '" + e + "' (searched as: '" + n + "')");
			}
		}
	}, t.exports._canonicalizeEncoding = function(e) {
		return ("" + e).toLowerCase().replace(/:\d{4}$|[^0-9a-z]/g, "");
	}, t.exports.getEncoder = function(e, r) {
		var n = t.exports.getCodec(e), o = new n.encoder(r, n);
		return n.bomAware && r && r.addBOM && (o = new i.PrependBOM(o, r)), o;
	}, t.exports.getDecoder = function(e, r) {
		var n = t.exports.getCodec(e), o = new n.decoder(r, n);
		return !n.bomAware || r && !1 === r.stripBOM || (o = new i.StripBOM(o, r)), o;
	}, t.exports.enableStreamingAPI = function(e) {
		if (!t.exports.supportsStreams) {
			var r = we()(e);
			t.exports.IconvLiteEncoderStream = r.IconvLiteEncoderStream, t.exports.IconvLiteDecoderStream = r.IconvLiteDecoderStream, t.exports.encodeStream = function(e, r) {
				return new t.exports.IconvLiteEncoderStream(t.exports.getEncoder(e, r), r);
			}, t.exports.decodeStream = function(e, r) {
				return new t.exports.IconvLiteDecoderStream(t.exports.getDecoder(e, r), r);
			}, t.exports.supportsStreams = !0;
		}
	};
	try {
		r = Ne();
	} catch (e) {}
	r && r.Transform ? t.exports.enableStreamingAPI(r) : t.exports.encodeStream = t.exports.decodeStream = function() {
		throw new Error("iconv-lite Streaming API is not enabled. Use iconv.enableStreamingAPI(require('stream')); to enable it.");
	};
}))(), 1), De = {}, Fe = {
	byteLength: function(e) {
		var t = Ge(e), r = t[0], n = t[1];
		return 3 * (r + n) / 4 - n;
	},
	toByteArray: function(e) {
		var t, r, n = Ge(e), i = n[0], o = n[1], s = new We(function(e, t, r) {
			return 3 * (t + r) / 4 - r;
		}(0, i, o)), a = 0, c = o > 0 ? i - 4 : i;
		for (r = 0; r < c; r += 4) t = qe[e.charCodeAt(r)] << 18 | qe[e.charCodeAt(r + 1)] << 12 | qe[e.charCodeAt(r + 2)] << 6 | qe[e.charCodeAt(r + 3)], s[a++] = t >> 16 & 255, s[a++] = t >> 8 & 255, s[a++] = 255 & t;
		return 2 === o && (t = qe[e.charCodeAt(r)] << 2 | qe[e.charCodeAt(r + 1)] >> 4, s[a++] = 255 & t), 1 === o && (t = qe[e.charCodeAt(r)] << 10 | qe[e.charCodeAt(r + 1)] << 4 | qe[e.charCodeAt(r + 2)] >> 2, s[a++] = t >> 8 & 255, s[a++] = 255 & t), s;
	},
	fromByteArray: function(e) {
		for (var t, r = e.length, n = r % 3, i = [], o = 16383, s = 0, a = r - n; s < a; s += o) i.push(Ve(e, s, s + o > a ? a : s + o));
		return 1 === n ? (t = e[r - 1], i.push($e[t >> 2] + $e[t << 4 & 63] + "==")) : 2 === n && (t = (e[r - 2] << 8) + e[r - 1], i.push($e[t >> 10] + $e[t >> 4 & 63] + $e[t << 2 & 63] + "=")), i.join("");
	}
}, $e = [], qe = [], We = "undefined" != typeof Uint8Array ? Uint8Array : Array, ze = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", He = 0; He < 64; ++He) $e[He] = ze[He], qe[ze.charCodeAt(He)] = He;
function Ge(e) {
	var t = e.length;
	if (t % 4 > 0) throw new Error("Invalid string. Length must be a multiple of 4");
	var r = e.indexOf("=");
...
function Ve(e, t, r) {
	for (var n, i = [], o = t; o < r; o += 3) n = (e[o] << 16 & 16711680) + (e[o + 1] << 8 & 65280) + (255 & e[o + 2]), i.push(Ye(n));
	return i.join("");
}
qe["-".charCodeAt(0)] = 62, qe["_".charCodeAt(0)] = 63;
var Xe = {
	/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */
	read: function(e, t, r, n, i) {
		var o, s, a = 8 * i - n - 1, c = (1 << a) - 1, f = c >> 1, u = -7, h = r ? i - 1 : 0, l = r ? -1 : 1, d = e[t + h];
...
* @license  MIT
*/ (function(e) {
	const t = Fe, r = Xe, n = "function" == typeof Symbol && "function" == typeof Symbol.for ? Symbol.for("nodejs.util.inspect.custom") : null;
	e.Buffer = f, e.SlowBuffer = function(e) {
	...
	function u(e, t, r) {
		...
		if (s.isView(e)) return function(e) {
			if (J(e, o)) {
				const t = new o(e);
		...
		if (null == e) throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " + typeof e);
		if (J(e, s) || e && J(e.buffer, s)) return p(e, t, r);
		if (void 0 !== a && (J(e, a) || e && J(e.buffer, a))) return p(e, t, r);
		if ("number" == typeof e) throw new TypeError("The \"value\" argument must not be of type number. Received type number");
		const n = e.valueOf && e.valueOf();
		if (null != n && n !== e) return f.from(n, t, r);
		const i = function(e) {
			if (f.isBuffer(e)) {
				const t = 0 | b(e.length), r = c(t);
				return 0 === r.length || e.copy(r, 0, 0, t), r;
			}
			return void 0 !== e.length ? "number" != typeof e.length || K(e.length) ? c(0) : d(e) : "Buffer" === e.type && Array.isArray(e.data) ? d(e.data) : void 0;
		}(e);
		if (i) return i;
	...
	function d(e) {
		const t = e.length < 0 ? 0 : 0 | b(e.length), r = c(t);
		for (let n = 0; n < t; n += 1) r[n] = 255 & e[n];
		return r;
	}
	function p(e, t, r) {
		...
		if (e.byteLength < t + (r || 0)) throw new RangeError("\"length\" is outside of buffer bounds");
		let n;
		return n = void 0 === t && void 0 === r ? new o(e) : void 0 === r ? new o(e, t) : new o(e, t, r), Object.setPrototypeOf(n, f.prototype), n;
	}
	function b(e) {
	...
	function g(e, t) {
		...
		if (s.isView(e) || J(e, s)) return e.byteLength;
		if ("string" != typeof e) throw new TypeError("The \"string\" argument must be one of type string, Buffer, or ArrayBuffer. Received type " + typeof e);
		const r = e.length, n = arguments.length > 2 && !0 === arguments[2];
		if (!n && 0 === r) return 0;
		let i = !1;
	...
	function y(e, t, r) {
		...
		for (e || (e = "utf8");;) switch (e) {
			...
			case "utf8":
			case "utf-8": return A(this, t, r);
			case "ascii": return O(this, t, r);
			case "latin1":
			case "binary": return I(this, t, r);
			case "base64": return T(this, t, r);
			case "ucs2":
			case "ucs-2":
			case "utf16le":
			case "utf-16le": return k(this, t, r);
			default:
				if (n) throw new TypeError("Unknown encoding: " + e);
				e = (e + "").toLowerCase(), n = !0;
		}
	...
	function v(e, t, r, n, i) {
		...
		if ("number" == typeof t) return t &= 255, "function" == typeof o.prototype.indexOf ? i ? o.prototype.indexOf.call(e, t, r) : o.prototype.lastIndexOf.call(e, t, r) : m(e, [t], r, n, i);
		throw new TypeError("val must be string, number or Buffer");
	}
	...
	f.TYPED_ARRAY_SUPPORT = function() {
		try {
			const e = new o(1), t = { foo: function() {
				return 42;
			} };
			return Object.setPrototypeOf(t, o.prototype), Object.setPrototypeOf(e, t), 42 === e.foo();
		} catch (e) {
			return !1;
		}
		...
		return u(e, t, r);
	}, Object.setPrototypeOf(f.prototype, o.prototype), Object.setPrototypeOf(f, o), f.alloc = function(e, t, r) {
		return function(e, t, r) {
		...
		if (J(e, o) && (e = f.from(e, e.offset, e.byteLength)), J(t, o) && (t = f.from(t, t.offset, t.byteLength)), !f.isBuffer(e) || !f.isBuffer(t)) throw new TypeError("The \"buf1\", \"buf2\" arguments must be one of type Buffer or Uint8Array");
		if (e === t) return 0;
		let r = e.length, n = t.length;
		for (let i = 0, o = Math.min(r, n); i < o; ++i) if (e[i] !== t[i]) {
			r = e[i], n = t[i];
		...
		for (r = 0; r < e.length; ++r) {
			let t = e[r];
			if (J(t, o)) i + t.length > n.length ? (f.isBuffer(t) || (t = f.from(t)), t.copy(n, i)) : o.prototype.set.call(n, t, i);
			else {
		...
		const r = e.INSPECT_MAX_BYTES;
		return t = this.toString("hex", 0, r).replace(/(.{2})/g, "$1 ").trim(), this.length > r && (t += " ... "), "<Buffer " + t + ">";
	}, n && (f.prototype[n] = f.prototype.inspect), f.prototype.compare = function(e, t, r, n, i) {
		if (J(e, o) && (e = f.from(e, e.offset, e.byteLength)), !f.isBuffer(e)) throw new TypeError("The \"target\" argument must be one of type Buffer or Uint8Array. Received type " + typeof e);
		if (void 0 === t && (t = 0), void 0 === r && (r = e ? e.length : 0), void 0 === n && (n = 0), void 0 === i && (i = this.length), t < 0 || r > e.length || n < 0 || i > this.length) throw new RangeError("out of range index");
		if (n >= i && t >= r) return 0;
		if (n >= i) return -1;
		if (t >= r) return 1;
		if (this === e) return 0;
		let s = (i >>>= 0) - (n >>>= 0), a = (r >>>= 0) - (t >>>= 0);
		const c = Math.min(s, a), u = this.slice(n, i), h = e.slice(t, r);
		for (let o = 0; o < c; ++o) if (u[o] !== h[o]) {
			s = u[o], a = h[o];
			break;
		}
		...
		let o = !1;
		for (;;) switch (n) {
			case "hex": return E(this, e, t, r);
			case "utf8":
			case "utf-8": return _(this, e, t, r);
			case "ascii":
			case "latin1":
			case "binary": return S(this, e, t, r);
			case "base64": return B(this, e, t, r);
			case "ucs2":
			case "ucs-2":
			case "utf16le":
			case "utf-16le": return R(this, e, t, r);
			default:
				if (o) throw new TypeError("Unknown encoding: " + n);
				n = ("" + n).toLowerCase(), o = !0;
		}
	...
	f.prototype.slice = function(e, t) {
		...
		n > this.length && (n = this.length), e.length - t < n - r && (n = e.length - t + r);
		const i = n - r;
		return this === e && "function" == typeof o.prototype.copyWithin ? this.copyWithin(t, r, n) : o.prototype.set.call(e, this.subarray(r, n), t), i;
		...
		if (t >>>= 0, r = void 0 === r ? this.length : r >>> 0, e || (e = 0), "number" == typeof e) for (i = t; i < r; ++i) this[i] = e;
			...
			const o = f.isBuffer(e) ? e : f.from(e, n), s = o.length;
			if (0 === s) throw new TypeError("The value \"" + e + "\" is invalid for argument \"value\"");
			for (i = 0; i < r - t; ++i) this[i + t] = o[i % s];
		}
		return this;
	...
	function H(e, t, r) {
		if (Math.floor(e) !== e) throw z(e, r), new F.ERR_OUT_OF_RANGE(r || "offset", "an integer", e);
	...
	$("ERR_BUFFER_OUT_OF_BOUNDS", (function(e) {
		...
		let n = `The value of "${e}" is out of range.`, i = r;
		return Number.isInteger(r) && Math.abs(r) > 2 ** 32 ? i = q(String(r)) : "bigint" == typeof r && (i = String(r), (r > BigInt(2) ** BigInt(32) || r < -(BigInt(2) ** BigInt(32))) && (i = q(i)), i += "n"), n += ` It must be ${t}. Received ${i}`, n;
	}), RangeError);
...
const Je = De.Buffer;
var Ke = c({
	convertEncodeByIconv: () => Ze,
	decodeByIconv: () => et,
	encodeByIconv: () => Qe
});
function Ze(e, t, r) {
	const n = Pe.default.encode(e, t);
	return Pe.default.decode(n, r);
}
function Qe(e, t, r) {
	return Pe.default.encode(e, t, r);
}
function et(e, t, r) {
	return Pe.default.decode(e, t, r);
}
globalThis.Buffer = Je, w(Ke);
